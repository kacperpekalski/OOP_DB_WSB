...
public class Main {
  public static void main(String[] args) {
    ...
    Client clientBasic = new Client("0", "Basic", "Client", LocalDate.of(1975, 2, 14), true, "man",
        "100200300", "basic.client@example.com");
    ...
    Client clientPremiumPlus =
        new PremiumClient("2", "Premiumplus", "Client", LocalDate.of(1960, 1, 2), false, "man",
            "700800900", "premiumplus.client@example.com", PremiumClientType.PREMIUM_PLUS);
    ...
    RoomReservation roomReservationForBasic =
        new RoomReservation(LocalDate.now(), clientBasic, roomForBasic);
    roomReservationForBasic.confirmReservation();
    RoomReservation roomReservationForPremium =
        new RoomReservation(LocalDate.now(), clientPremium, roomForPremium);
    RoomReservation roomReservationForPremiumPlus =
        new RoomReservation(LocalDate.now(), clientPremiumPlus, roomForPremiumPlus);
    roomReservationForBasic.confirmReservation();
